                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                               <!--  <form class="form-horizontal"> -->
                                    ...
                                    <div class="col-lg-2 form-group">
                                   	 ...
                                   	 <div class="col-lg-4 form-group">
                                        <input type="file" id="file" name="file" style="display:inline;" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel"/>
                                        <input type="button" id="submit" value="导入" style="display:inline;" onclick="uploadFile()"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%"  style="table-layout:fixed;margin-bottom:5;font-size:13px;">
                            ...
                            <tr>
                                <th width="11%">学号</th>
                                <th width="11%">姓名</th>
                                <th width="11%">学位课成绩</th>
                                <th width="11%">学位课排名</th>
                            ...
                            <c:forEach var="student" items="${studentInfo.studentList }" varStatus="i">
                             <tbody>
	                                ...
	                                <td>${student.name}</td>
	                                <td>${student.degreeCourseScore}</td>
	                                <td>${student.degreeCourseRank}</td>
                        ...
                        <div class="pull-right" id="paginationFoot">
                           ...
                           <li><a href="${pageContext.request.contextPath}/student/studentScoreList.action?page=1">首页</a></li>
                           <li><a href="${pageContext.request.contextPath}/student/studentScoreList.action?page=${studentInfo.currentPage-1 }">&laquo;</a></li><!-- 上一页 -->
								...
								<c:forEach begin="${begin }" end="${end }" var="i">
								  <c:choose>
								  	...
								  	<c:otherwise>
								  		<li><a href="${pageContext.request.contextPath}/student/studentScoreList.action?page=${i}">${i}</a></li>
								  	</c:otherwise>
								  </c:choose>
								</c:forEach>
				        	
							  <c:if test="${studentInfo.currentPage < studentInfo.totalPage }">
								  <li><a href="${pageContext.request.contextPath}/student/studentScoreList.action?page=${studentInfo.currentPage+1}">&raquo;</a></li>
							</c:if>
							
							<li><a href="${pageContext.request.contextPath}/student/studentScoreList.action?page=${studentInfo.totalPage}">尾页</a></li>
							<li>
