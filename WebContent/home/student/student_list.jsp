...
<script src="/js/home/student/student_list.js"></script>
</head>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="pull-right" id="paginationFoot">
                           ...
                           <li><a href="${pageContext.request.contextPath}/student/studentList.action?page=1">首页</a></li>
                           <li><a href="${pageContext.request.contextPath}/student/studentList.action?page=${studentInfo.currentPage-1 }">&laquo;</a></li><!-- 上一页 -->
								...
								<c:forEach begin="${begin }" end="${end }" var="i">
								  <c:choose>
								  	...
								  	<c:otherwise>
								  		<li><a href="${pageContext.request.contextPath}/student/studentList.action?page=${i}">${i}</a></li>
								  	</c:otherwise>
								  </c:choose>
								</c:forEach>
				        	
							  <c:if test="${studentInfo.currentPage < studentInfo.totalPage }">
								  <li><a href="${pageContext.request.contextPath}/student/studentList.action?page=${studentInfo.currentPage+1}">&raquo;</a></li>
							</c:if>
							
							<li><a href="${pageContext.request.contextPath}/student/studentList.action?page=${studentInfo.totalPage}">尾页</a></li>
							<li>
