...
<script type="text/javascript" src="/js/home/blog/blog_edit.js"></script>
                        ...
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                               ...
                               <!--  <form class="form-horizontal"> -->
                                    ...
                                    <div class="col-lg-12 form-group">
                                        ...
                                        <div class="col-lg-10 form-group" id="tagDiv">
		                                   <!-- <div style = "width:13%;float:left">
                                    		...
                                    		<div style = "width:20%;float:left" id="tagInputDiv">
		                           ...
		                           <div class="col-lg-12 form-group">
		                                        <label class="col-lg-2 control-label" for="query_bno1"></label>
		                                        <div class="col-lg-10 form-group" id="tagDiv">
				                                
		                                    		<div style = "width:100%;float:left" id="tagHasInputed">
		                                    		<ul id="tagHasInputedUl">
          												<!-- <li style="float:left"><label>111</label></li>
          												<li style="float:left"><label>111</label></li>
          												<li style="float:left"><label>111</label></li> -->
         											</ul>
		                                    		</div> 
