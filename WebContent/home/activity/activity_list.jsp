...
<script src="/js/home/activity/activity_list.js"></script>
</head>
                    ...
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%" style="table-layout:fixed;margin-bottom:5;">
                            ...
                            <c:forEach var="activity" items="${activityInfo.activityList }" varStatus="i">
                             <tbody>
	                         	   <td><a href="javascript:void(0)" onclick="detail('${activity.activityId}')">${activity.name}</a></td>
	            					...
	            					<td>
	            						<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#findModal" onclick="detail('${activity.activityId}')" >查看</button>
	            						 <c:choose>
	            						  <c:when test="${activity.enrollFlag == true}">
	            							<button type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#findModal" onclick="participateIn('${activity.activityId}')" >报名</button>
	                               		  </c:when>
	                               		</c:choose>
	                               	</td> 
