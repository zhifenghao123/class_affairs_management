...
<script type="text/javascript" src="/js/home/activity/activity_update.js"></script>
                        ...
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                               ...
                               <!--  <form class="form-horizontal"> -->
                                    ...
                                    <div class="col-lg-12 form-group">
                                        <label class="col-lg-2 control-label" for="query_bname3">报名截止时间</label>
                                        <div class="col-lg-9">
                                           <input id="enrollEndTime" class="Wdate" name="start"	type="text" style="width: 150px;"	onclick="WdatePicker({readOnly:true,minDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd HH:mm:ss',});" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12 form-group">
