...
//        ,snapscreenServerPort: location.port                                   //屏幕截图的server端端口
 ...
 'fontfamily', 'fontsize', 'forecolor' ,'|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|',
                
                'lineheight', 'imagenone', 'imageleft', 'imageright', 'imagecenter','removeformat','insertimage', 'emotion', 
